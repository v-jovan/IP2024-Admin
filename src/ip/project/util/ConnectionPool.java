...
public class ConnectionPool {
	...
	private ConnectionPool(ServletContext context) {
		Properties properties = new Properties();
		try {
			try (InputStream input = getClass().getClassLoader()
					.getResourceAsStream("ip/project/util/ConnectionPool.properties")) {
				if (input == null) {
					throw new RuntimeException("Properties file not found in the package.");
				}
